...
export function ReportsPageContent({
  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-10 px-6 py-10">
      <header className="grid grid-cols-1 gap-4 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-start">
      ...
      <section className="border-t border-zinc-200 pt-10">
        ...
        <ul className="mt-5 max-h-[400px] divide-y divide-zinc-200 overflow-y-auto rounded-lg border border-zinc-200 bg-white shadow-sm">
              ...
              return (
                <li key={report.id}>
                  <button
                    ...
                    className={`flex w-full min-h-11 min-w-0 items-center justify-between gap-3 px-5 py-3.5 text-left transition-colors ${
